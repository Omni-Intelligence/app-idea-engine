...
export const ProjectDetailsCard = ({ project, children }: ProjectDetailsCardProps) => {
  ...
  return (
    <Card className="overflow-hidden border border-gray-200 shadow-sm hover:shadow-md transition-all duration-200">
      <CardHeader className="border-b border-gray-100 bg-muted">
      ...
      <CardContent className="p-6 space-y-6">
        <div className="space-y-4">
          <div className="flex items-center gap-2">
            ...
            <h3 className="font-poppins text-sm font-medium text-gray-700">Description</h3>
          </div>
      ...
      <CardFooter className="border-t border-gray-100 bg-muted px-6 py-4">
